// topPage: トップページでの見せ方。'full'（既定）/ 'compact'（1行だけ）/ false（出さない）。
// 'compact' の行は topSchool / topPeriod / topDegree を使い、学科名と補足は出さない。
const education = [
  {
    id: 'edu-01',
    school: '東京理科大学大学院',
  ...
  },
  {
    id: 'edu-03',
    school: '本郷高等学校',
    // トップページでは中学からの在籍を1行にまとめて出す（データは中学・高校を分けて保持する）
    topPage: 'compact',
    topSchool: '本郷中学校・高等学校',
    topPeriod: '2014年4月〜2020年3月',
    topDegree: '中高一貫課程',
    faculty: '普通科',
    degree: '',
