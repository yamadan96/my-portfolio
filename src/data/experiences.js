  ...
  },
  {
    ...
    details: {
      ...
      responsibilities: [
        ...
        '【承認時期予測モデル開発】日次予測でMAE 1.3日を達成。高・中・低の3段階信頼度スコアを導入して出力を振り分け、低信頼度の予測にはルール補正とセカンダリモデルによる再予測を適用。高信頼度予測では月次正解率99%以上を実現。信頼度別にモデルを分ける案も検証したが、単一モデルの方が高精度だったため採用しなかった',
