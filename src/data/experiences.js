const experiences = [
  ...
  },
  {
    ...
    details: {
      ...
      responsibilities: [
        'AI契約書チェックOSS（AI契約書チェックOSS）のv0.1.0リリース前品質検証: NDA・業務委託・システム開発・売買の4契約類型で仕込み問題点22件を100%検出し、OSSのPublic公開・v0.1.0リリースに貢献',
      ...
      achievements:
        'AI契約書チェックOSS（AI契約書チェックOSS）v0.1.0公開に貢献、チェックリスト変換スクリプトPRマージ',
      techStack: [
        'Python',
        'FastAPI',
        'SQLAlchemy',
  ...
  },
  {
    ...
    description:
      '日記生成AI開発（NLP）、銀行太陽光ブロックチェーンプロジェクトのテスト設計。',
    ...
    details: {
      ...
      responsibilities: [
        ...
        '銀行太陽光システムプロジェクト: 太陽光発電データに基づくブロックチェーン取引のテスト設計・検証',
