...
const experiences = [
  ...
  },
  {
    ...
    top: {
      built: '製造ライン向け物体検出 PoC をテックリードとして開発。ロボット向け音声合成も製品開発',
      metrics: [
        { value: '96.6%', label: '束単位の検出成功率（社内評価）' },
        { value: '0.2秒/枚', label: '推論時間' },
      ],
      roleLine: '鉄パイプ計数 PoC で 4名チームのテックリード',
    ...
    summary: {
      ...
      role: 'AIエンジニアとして複数の企業向けAI開発を担当。モデル選定・データ設計・学習・評価から、API化・業務自動化・顧客報告まで一貫して担当。鉄パイプ自動計数PoCでは4名チームのテックリードを担当。',
    ...
    details: {
      ...
      projects: [
        ...
        },
        {
          ...
          period: '',
          icon: '🔩',
          summary: '束ねた鉄パイプの本数を画像から数えるAIのPoC（試作検証）。技術責任者（テックリード）としてモデル選定から学習・評価までを担当した。',
  ...
  },
  {
    ...
    top: {
      built: '家族アルバムアプリの画像解析パイプラインの高速化とコスト削減を担当',
      metrics: [
