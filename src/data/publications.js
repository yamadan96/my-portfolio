...
const publications = [
  ...
  },
  {
    ...
    detail: {
      ...
      dataset:
        '能登半島地震の被災建物を現地で撮影した地上写真 1,040枚（518×518画素）。衛星画像ではない。' +
        '6クラス（被害なし／地震の損傷度 大・中・小／津波の損傷度 大・小）のラベルは専門家が付与した。',
      method:
  ...
  },
  {
    ...
    detail: {
      ...
      dataset:
        '2024年能登半島地震の被災家屋を現地で撮影した地上写真の独自データセット（衛星画像ではない）。1,040枚・6クラス・518×518画素、訓練832枚・評価208枚の固定分割。' +
  ...
  },
  {
    ...
    detail: {
      ...
      dataset: 'OOPS! データセット。事故やハプニングの瞬間を含む、一般に公開された3〜5秒の短い動画を使う。',
      method:
        'Clockwork Variational Autoencoder（CW-VAE）を活用したフレーム外挿モデル。動画の長期文脈から次のフレームを予測し、予測と実際の差が大きいところを異常とみなす。' +
        '事前学習済みモデルは使わず、VAE を拡張した小規模なモデルをランダム初期化から学習した（学習に1〜2週間）。',
