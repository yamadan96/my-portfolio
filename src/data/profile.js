...
const profile = {
  ...
  bio: [
    '実務：LLM Agent / RAG / Computer Vision を中心に、研究・PoCから本番実装まで経験。約12名のLLM Agent開発ではRAG部分を設計・実装し、製造業向けComputer Visionではエンジニア兼テックリードを担当。LegalOnでは契約書分類モデルのLLM化から本番導入可能なマイクロサービスの実装まで、別のLegalTech案件では2名体制で設計から本番リリースまで担当。',
